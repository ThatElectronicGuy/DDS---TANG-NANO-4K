...
create_generated_clock -name CLK100_8 -source [get_pins {top/PLL/pllvr_inst/CLKOUT}] -divide_by 3 [get_pins {top/PLL/pllvr_inst/CLKOUTD3}]

create_clock -name MSCLK -period 41666.667 [get_ports {MSCLK}]

set_clock_groups -asynchronous -group [get_clocks{CLK27 CLK302_4 CLK100_8}] -group [get_clocks{MSCLK}]
